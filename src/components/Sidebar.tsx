...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    icon: <IconFinance />,
    children: [
      { name: 'Packages', href: '/finance/packages' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Sampling', href: '/iqa/sampling' },
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-slate-900 text-slate-300 shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700/60">
        ...
        <div>
          <p className="text-white font-semibold text-sm leading-tight">LMS Admin</p>
          ...
          return (
            <div key={section.name} className="mb-1">
              <button
                ...
                `}
              >
                <span className={isAssessment ? 'text-orange-400' : ''}>{section.icon}</span>
